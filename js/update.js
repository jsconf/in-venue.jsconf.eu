  ...
  })(
    {
        ...
        function(e, t) {
          ...
          function n(e, t) {
            !(function(e, t) {
              ...
              t.nodeType === v
                ? i(e, t)
                : r(e, "string" == typeof t ? s(t, e.nodeName) : t),
              e[m] || ((e[m] = !0), f(e));
          }
          function r(e, t) {
            ...
            else e.parentNode.replaceChild(t, u(e)), f(t);
          }
          function i(e, t) {
            for (
              var n, i, d, a, l, s, c = e.firstChild, m = t.firstChild, p = 0;
              c;
            ...
            for (c = e.firstChild; m; )
              p--,
                ...
                s && (a = o(d)) && (l = s[a])
                  ? (delete s[a],
                    l !== c ? e.insertBefore(l, c) : (c = c.nextSibling),
                    r(l, d))
                  : c
                  ? ((n = c),
                    (c = c.nextSibling),
                    o(n) ? (e.insertBefore(d, n), f(d)) : r(n, d))
                  : (e.appendChild(d), f(d));
            for (i in s) p--, e.removeChild(u(s[i]));
            for (; --p >= 0; ) e.removeChild(u(e.lastChild));
          }
          function o(e) {
            if (e.nodeType === p) {
          ...
          function l(e, t) {
            ...
            for (var i = e.firstChild; i; ) i = l(i, t).nextSibling;
            return e;
          }
          (n.KEY = "data-key"),
      ...
      2: [
        function(e, t) {
          ...
          try {
            var u = r.parseFromString('<wbr class="A"/>', a).body.firstChild,
